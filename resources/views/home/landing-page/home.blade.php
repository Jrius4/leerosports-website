          ...
          <div class="container">
            <div data-slider-id="1" class="owl-carousel hero-1-slider">
              ...
              <div class="item">
                ...
                <div class="col-md-6 product"><img src="{{asset('/images/leero png-03.png')}}" alt="lens" class="img-fluid image-header d-none d-md-block"></div>
                </div>
              </div>
              <!-- Slide END-->
          ...
          <div class="container text-center">
            ...
            <div class="row d-flex justify-content-around">
                ...
                @foreach ($clients as $client)
                    ...
                    <img height="75" style="max-width:150px" src="{{$client->imageUrl}}" alt="{{$client->name}}">
                    </span>
                @endforeach
                @endif
