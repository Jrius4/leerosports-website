  ...
  <aside class="main-sidebar sidebar-light-danger elevation-4">
        ...
        <a href="{{url('/')}}" class="brand-link" target="_blanck">
          <img width="50" width="75" src="{{asset('/img/logos/leero pngs-02.png')}}" alt="ndebitech Logo" class="brand-image img-circle elevation-3"
               style="opacity: .8">
          <span class="brand-text font-weight-light">Leero Sports</span>
        </a>
